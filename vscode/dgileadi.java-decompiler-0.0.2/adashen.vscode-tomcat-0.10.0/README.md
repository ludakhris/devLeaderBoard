...
![start and run](https://github.com/adashen/vscode-tomcat/raw/master/resources/Tomcat.gif)
...
This project has adopted the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). For more information see the [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) or contact [opencode@microsoft.com](https://github.com/adashen/vscode-tomcat/blob/master/mailto:opencode@microsoft.com) with any additional questions or comments.

## Release Notes
Refer to [CHANGELOG](https://github.com/adashen/vscode-tomcat/blob/master/CHANGELOG.md)
